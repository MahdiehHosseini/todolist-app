...
const TimerSecion : FC<TimerComponentInterface> = ({time}) => {
	...
	return (
		<span className=" flex justify-center mt-2/3 sm:mt-1/10"> 
			<div className="border-dotted border-zinc-300 border-8 absolute flex justify-center rounded-full">
				<div className={`border-dotted border-[${them}] border-8 relative -m-2 rounded-full`}>
